...
class BikeRentalCancellationSuccessScreen extends StatelessWidget {
  final double refundAmount;

  const BikeRentalCancellationSuccessScreen({
    super.key,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Your bike rental booking has been successfully cancelled.',
