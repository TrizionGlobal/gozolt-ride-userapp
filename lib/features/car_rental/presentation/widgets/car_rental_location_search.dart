...
class CarRentalLocationField extends StatelessWidget {
...
class CarRentalLocationSearchSheet extends StatefulWidget {
  final ValueChanged<LocationData> onSelect;
  final bool showCurrentLocation;

  const CarRentalLocationSearchSheet({
    super.key,
  ...
  @override
  State<CarRentalLocationSearchSheet> createState() => _CarRentalLocationSearchSheetState();
}

class _CarRentalLocationSearchSheetState extends State<CarRentalLocationSearchSheet> {
