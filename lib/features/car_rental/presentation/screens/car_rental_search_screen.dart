...
class CarRentalSearchScreen extends ConsumerStatefulWidget {
  const CarRentalSearchScreen({super.key});

  @override
  ConsumerState<CarRentalSearchScreen> createState() => _CarRentalSearchScreenState();
}

class _CarRentalSearchScreenState extends ConsumerState<CarRentalSearchScreen> {
  ...
  void _selectLocation(String field) {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => CarRentalLocationSearchSheet(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Text('Return Car to Same Location'),
                    ],
                  ),
                  ...
                  _buildSectionHeader(isDark, 'Vehicle Delivery Option'),
                  const SizedBox(height: 8),
                  ...
                  GozoltButton(
                    ...
                    onPressed: () {
                      ...
                      ref.read(carRentalSearchProvider.notifier).setSearchOptions(
                        type: _deliveryType,
                      ...
                      context.pushNamed(RouteNames.carRentalList);
                    },
                  ),
                  const SizedBox(height: 40),
                ],
