...
class GardeningConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;
  const GardeningConfirmationScreen({super.key, required this.bookingData});
  ...
  Widget build(BuildContext context) {
    const bookingId = 'GZT-QS-GARDEN-892401';
    final serviceTitle = bookingData.selectedServiceTitle ?? 'Gardening';
    
    String areaInfo = '';
    if (bookingData.gardeningServiceArea != null || bookingData.gardeningApproximateArea != null) {
      final sa = bookingData.gardeningServiceArea ?? 'Not selected';
      final aa = bookingData.gardeningApproximateArea ?? 'Not selected';
      areaInfo = ' ($sa • $aa)';
    }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              const Icon(Icons.yard, size: 16),
                              const SizedBox(width: 8),
                              Expanded(
                                child: Text(
                                  '$serviceTitle$areaInfo',
