...
class CarMechanicDetailsScreen extends ConsumerStatefulWidget {
  final QuickServiceBookingData bookingData;
  const CarMechanicDetailsScreen({super.key, required this.bookingData});

  @override
  ConsumerState<CarMechanicDetailsScreen> createState() => _CarMechanicDetailsScreenState();
}

class _CarMechanicDetailsScreenState extends ConsumerState<CarMechanicDetailsScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(_typeController, 'e.g. Sedan, SUV', false),
                  const SizedBox(height: 16),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            _buildTextField(_makeController, 'e.g. Toyota', false),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            _buildTextField(_modelController, 'e.g. Corolla', false),
                          ],
                        ),
                      ),
                    ],
                          ...
                          child: OutlinedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('Add Car', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ),
                  ...
                  if (_savedVehicles.isNotEmpty) ...[
                    ...
                    Text(
                      'Added Cars (${_savedVehicles.length})',
                      style: AppTextStyles.titleMedium.copyWith(fontWeight: FontWeight.bold),
                    ),
                    const SizedBox(height: 8),
                    ListView.separated(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (_savedVehicles.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Please add at least one car to proceed.'),
                            backgroundColor: Colors.red,
                          ),
                        );
                        return;
                      ...
                      if (_selectedImages.isNotEmpty) {
                        ...
                        ref.read(quickServicesBookingProvider.notifier).uploadImages(
                          ...
                          if (mounted) context.pushNamed(RouteNames.quickServicesCarMechanicReview, extra: finalDataObj);
                        }).catchError((e) {
                          if (mounted) setState(() => _isUploading = false);
                          if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Failed to upload images')));
                        });
                      } else {
                        if (mounted) context.pushNamed(RouteNames.quickServicesCarMechanicReview, extra: updatedBookingData);
                      }
                    },
