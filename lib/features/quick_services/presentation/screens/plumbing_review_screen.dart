...
class PlumbingReviewScreen extends StatefulWidget {
  final QuickServiceBookingData bookingData;
  const PlumbingReviewScreen({super.key, required this.bookingData});

  @override
  State<PlumbingReviewScreen> createState() => _PlumbingReviewScreenState();
}

class _PlumbingReviewScreenState extends State<PlumbingReviewScreen> {
  bool useCoins = false;
