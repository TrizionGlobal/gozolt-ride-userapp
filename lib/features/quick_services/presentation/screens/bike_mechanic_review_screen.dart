...
class BikeMechanicReviewScreen extends StatefulWidget {
  final QuickServiceBookingData bookingData;
  const BikeMechanicReviewScreen({super.key, required this.bookingData});

  @override
  State<BikeMechanicReviewScreen> createState() => _BikeMechanicReviewScreenState();
}

class _BikeMechanicReviewScreenState extends State<BikeMechanicReviewScreen> {
  bool useCoins = false;
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text('Bike Mechanic', style: AppTextStyles.titleMedium.copyWith(fontWeight: FontWeight.bold)),
                          ],
                        ),
                        const Divider(height: 24),
                        _buildDetailRow('Bike Type', widget.bookingData.bikeType ?? '-'),
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: ElevatedButton(
            onPressed: () {
              context.pushNamed(
                RouteNames.quickServicesBikeMechanicConfirmation,
