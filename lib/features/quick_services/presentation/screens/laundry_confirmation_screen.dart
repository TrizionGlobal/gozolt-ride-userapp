...
class LaundryConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;
  const LaundryConfirmationScreen({super.key, required this.bookingData});
  ...
  Widget build(BuildContext context) {
    const bookingId = 'GZT-QS-260924-6241';
    final serviceTitle = bookingData.selectedServiceTitle ?? 'Laundry & Ironing';
    final serviceMethod = bookingData.laundryServiceMethod != null ? ' (${bookingData.laundryServiceMethod})' : '';
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              const Icon(Icons.local_laundry_service, size: 16),
                              const SizedBox(width: 8),
                              Expanded(
                                child: Text(
                                  '$serviceTitle$serviceMethod',
