...
class BikeMechanicConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;
  const BikeMechanicConfirmationScreen({super.key, required this.bookingData});
