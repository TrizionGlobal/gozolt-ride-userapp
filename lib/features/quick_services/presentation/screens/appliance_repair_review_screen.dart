...
class ApplianceRepairReviewScreen extends StatefulWidget {
  final QuickServiceBookingData bookingData;
  const ApplianceRepairReviewScreen({super.key, required this.bookingData});

  @override
  State<ApplianceRepairReviewScreen> createState() => _ApplianceRepairReviewScreenState();
}

class _ApplianceRepairReviewScreenState extends State<ApplianceRepairReviewScreen> {
  bool useCoins = false;
          ...
          SafeArea(
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  context.pushNamed(
                    RouteNames.quickServicesApplianceRepairConfirmation,
