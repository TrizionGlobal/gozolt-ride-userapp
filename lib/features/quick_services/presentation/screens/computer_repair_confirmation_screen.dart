...
class ComputerRepairConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const ComputerRepairConfirmationScreen({super.key, required this.bookingData});
  ...
  Widget build(BuildContext context) {
    final deviceBrand = bookingData.computerBrand ?? 'Dell';
    final deviceModel = bookingData.computerModel ?? 'Inspiron 15';
    final serviceTitle = 'Computer & Laptop Repair ($deviceBrand $deviceModel)';
