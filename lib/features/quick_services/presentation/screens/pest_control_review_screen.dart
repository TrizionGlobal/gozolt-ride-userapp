                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Service Subtotal', style: AppTextStyles.bodyMedium),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Tax & Fees', style: AppTextStyles.bodyMedium),
                            Text('€0.00', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                          ],
                        ),
                        const Divider(height: 24),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Total Amount', style: AppTextStyles.bodyLarge.copyWith(fontWeight: FontWeight.bold)),
                            Text('€${booking.subtotal.toStringAsFixed(2)}',
                                style: AppTextStyles.titleMedium
                                    .copyWith(fontWeight: FontWeight.bold, color: AppColors.primaryGold)),
                          ],
                        ),
                      ],
                    ),
            ...
            child: SafeArea(
              ...
              child: ElevatedButton(
                ...
                child: Text('CONFIRM BOOKING',
                    style: AppTextStyles.button.copyWith(fontWeight: FontWeight.bold, color: Colors.black)),
              ),
            ),
          ),
        ],
