...
class HandymanConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const HandymanConfirmationScreen({super.key, required this.bookingData});
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(bookingData.selectedServiceTitle ?? 'Handyman Services', style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
