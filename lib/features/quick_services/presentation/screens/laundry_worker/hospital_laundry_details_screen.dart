...
class HospitalLaundryDetailsScreen extends ConsumerStatefulWidget {
  final QuickServiceBookingData bookingData;

  const HospitalLaundryDetailsScreen({super.key, required this.bookingData});

  @override
  ConsumerState<HospitalLaundryDetailsScreen> createState() => _HospitalLaundryDetailsScreenState();
}

class _HospitalLaundryDetailsScreenState extends ConsumerState<HospitalLaundryDetailsScreen> {
  ...
  final List<Map<String, dynamic>> _laundryServices = [
    ...
    {'title': 'Bed Linen', 'icon': Icons.bed, 'priceText': '', 'unitPrice': 0.0},
    {'title': 'Patient Gowns', 'icon': Icons.local_hospital, 'priceText': '', 'unitPrice': 0.0},
    {'title': 'Towels', 'icon': Icons.layers, 'priceText': '', 'unitPrice': 0.0},
    {'title': 'Staff Uniforms', 'icon': Icons.checkroom, 'priceText': '', 'unitPrice': 0.0},
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Facility Details
                  Text('Facility Details', style: AppTextStyles.titleMedium.copyWith(fontWeight: FontWeight.bold)),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                _materialPreference == 'Bring materials' ? '+€${QuickServicesPricingConfig.getMaterialCost('hospital_laundry').toStringAsFixed(2)} extra charge' : 'Use my materials (No extra charge)',
                                style: AppTextStyles.bodySmall.copyWith(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (_facilityNameController.text.trim().isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Please enter Facility Name.'), backgroundColor: Colors.red));
                        return;
                      }
                      ...
                      final updatedData = widget.bookingData.copyWith(
                        ...
                        pickupAndReturnFee: _selectedMethod == 'Pickup & Return' ? QuickServicesPricingConfig.getPickupFee('hospital_laundry') : 0.0,
