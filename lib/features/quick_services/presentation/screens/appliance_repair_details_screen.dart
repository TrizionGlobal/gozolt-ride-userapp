                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      _applianceCounts.forEach((appliance, count) {
                        if (count > 0) {
                          selectedAddons.add(ServiceAddon(name: appliance, count: count, pricePerUnit: 0.00)); // The price is not per addon here, it's a fixed visit fee
                        }
                      });
                      ...
                      final updatedData = widget.bookingData.copyWith(
                        ...
                        subtotal: 20.00, // Fixed 20 euro visit fee as per mockup
                      );
