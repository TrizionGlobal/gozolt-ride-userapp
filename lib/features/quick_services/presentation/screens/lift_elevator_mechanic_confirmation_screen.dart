...
class LiftElevatorMechanicConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;
  const LiftElevatorMechanicConfirmationScreen({super.key, required this.bookingData});
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              const Icon(Icons.elevator, size: 16),
                              const SizedBox(width: 8),
                              Text(bookingData.selectedServiceTitle ?? 'Lift / Elevator Mechanic', style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
