                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _bookingData.selectedServiceTitle ?? 'Handyman Services',
                        ...
                        if (_bookingData.wallType != null) ...[
                          const SizedBox(height: 6),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Wall Type', style: AppTextStyles.bodyMedium.copyWith(color: Colors.grey.shade700)),
                              Text(_bookingData.wallType!, style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ],
            ...
            child: Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    context.pushNamed(RouteNames.quickServicesHandymanConfirmation, extra: _bookingData);
                  },
