...
class HomeElectricConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const HomeElectricConfirmationScreen({super.key, required this.bookingData});
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(bookingData.selectedServiceTitle ?? 'Electrical Services', style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
