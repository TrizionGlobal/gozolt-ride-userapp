...
class ApplianceRepairConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;
  const ApplianceRepairConfirmationScreen({super.key, required this.bookingData});
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(bookingData.selectedServiceTitle ?? 'Quick Service', style: const TextStyle(fontWeight: FontWeight.bold)),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
