...
class CarWashReviewScreen extends StatefulWidget {
  final QuickServiceBookingData bookingData;

  const CarWashReviewScreen({super.key, required this.bookingData});

  @override
  State<CarWashReviewScreen> createState() => _CarWashReviewScreenState();
}

class _CarWashReviewScreenState extends State<CarWashReviewScreen> {
