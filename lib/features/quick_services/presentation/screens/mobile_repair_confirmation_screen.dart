...
class MobileRepairConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const MobileRepairConfirmationScreen({super.key, required this.bookingData});
  ...
  Widget build(BuildContext context) {
    final deviceBrand = bookingData.deviceBrand ?? 'Samsung';
    final deviceModel = bookingData.deviceModel ?? 'Galaxy S23';
    final serviceTitle = 'Mobile Repair at Home ($deviceBrand $deviceModel)';
