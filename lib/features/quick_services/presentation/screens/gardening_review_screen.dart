                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        _priceRow('Visit / Inspection Fee', '€12.00'),
                        const SizedBox(height: 8),
                        _priceRow('Estimated Labour', '€30–€80'),
                        const SizedBox(height: 8),
                        _priceRow('Materials / Plants', 'Not Included'),
                        const SizedBox(height: 8),
                        _priceRow('Green Waste Removal', 'Final quote after inspection'),
                      ],
                    ),
                  ),
