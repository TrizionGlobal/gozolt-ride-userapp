...
class TruckWashReviewScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TruckWashReviewScreen> createState() => _TruckWashReviewScreenState();
}
                  ...
                  ElevatedButton(
                    onPressed: _isBooking ? null : () async {
                      ...
                      if (bookingId != null && mounted) {
                        context.pushNamed(RouteNames.quickServicesTruckWashConfirmation, extra: updatedData.copyWith(bookingId: bookingId));
                      } else {
