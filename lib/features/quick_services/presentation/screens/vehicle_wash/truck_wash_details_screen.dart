...
class TruckWashDetailsScreen extends ConsumerStatefulWidget {
  final QuickServiceBookingData bookingData;

  const TruckWashDetailsScreen({super.key, required this.bookingData});

  @override
  ConsumerState<TruckWashDetailsScreen> createState() => _TruckWashDetailsScreenState();
}

class _TruckWashDetailsScreenState extends ConsumerState<TruckWashDetailsScreen> {
                    ...
                    onPressed: () {
                      ...
                      if (_selectedImages.isNotEmpty) {
                        ...
                        ref.read(quickServicesBookingProvider.notifier).uploadImages(
                          ...
                          if (mounted) {
                            context.pushNamed(
                              RouteNames.quickServicesTruckWashReview,
                              extra: finalDataObj,
                            );
                          }
                        }).catchError((e) {
