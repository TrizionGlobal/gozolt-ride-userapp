...
class CarWashDetailsScreen extends ConsumerStatefulWidget {
  final QuickServiceBookingData bookingData;

  const CarWashDetailsScreen({super.key, required this.bookingData});

  @override
  ConsumerState<CarWashDetailsScreen> createState() => _CarWashDetailsScreenState();
}

class _CarWashDetailsScreenState extends ConsumerState<CarWashDetailsScreen> {
