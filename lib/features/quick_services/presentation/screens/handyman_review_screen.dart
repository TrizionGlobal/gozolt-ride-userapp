...
class HandymanReviewScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const HandymanReviewScreen({super.key, required this.bookingData});
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          bookingData.selectedServiceTitle ?? 'Handyman Services',
                        ...
                        if (bookingData.selectedAddons.isNotEmpty) ...[
                          ...
                          Text(
                            '• General Handyman Inspection / Repair',
                        ...
                        if (bookingData.wallType != null) ...[
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Wall Type', style: AppTextStyles.bodyMedium.copyWith(color: Colors.grey.shade700)),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text('€30 - €70', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Materials / Fixtures', style: AppTextStyles.bodyMedium),
            ...
            child: Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    context.pushNamed(RouteNames.quickServicesHandymanConfirmation, extra: bookingData);
                  },
