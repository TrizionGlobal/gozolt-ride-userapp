                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text('€14.00 / hr', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                          ],
                        ),
                        const SizedBox(height: 8),
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Labour ($hours ${hours == 1 ? 'hr' : 'hrs'} × $helpers ${helpers == 1 ? 'helper' : 'helpers'})',
                                style: AppTextStyles.bodyMedium,
                              ),
                            ),
                            Text(
                              '€${totalLabour.toStringAsFixed(2)}',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text('€2.00', style: AppTextStyles.bodyMedium.copyWith(color: Colors.grey)),
                          ],
                        ),
