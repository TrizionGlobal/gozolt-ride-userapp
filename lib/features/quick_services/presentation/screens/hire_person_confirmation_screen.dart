...
class HirePersonConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const HirePersonConfirmationScreen({super.key, required this.bookingData});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Show QR code to the assigned helper',
                      textAlign: TextAlign.center,
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(bookingData.selectedServiceTitle ?? 'Hire a Person', style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('€${bookingData.estimatedTotal.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ],
                      ),
                    ...
                    Row(
                      ...
                      children: const [
                        ...
                        SizedBox(width: 8),
                        Text('Helper assignment pending', style: TextStyle(color: Colors.orange, fontSize: 12)),
                      ],
                    ),
                    const SizedBox(height: 24),
                    Center(
