...
class SecurityPersonnelConfirmationScreen extends StatelessWidget {
  final QuickServiceBookingData bookingData;

  const SecurityPersonnelConfirmationScreen({super.key, required this.bookingData});
  ...
  Widget build(BuildContext context) {
    final bookingId = 'GZT-QS-${(bookingData.scheduleDate.millisecondsSinceEpoch % 1000000).toString().padLeft(6, '0')}';
    final serviceTitle = bookingData.securityService ?? bookingData.selectedServiceTitle ?? 'Security Personnel';
    final estimatedTotal = bookingData.subtotal > 0 ? bookingData.subtotal : 150.0;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Show QR code to the assigned professional',
                      textAlign: TextAlign.center,
                    ...
                    const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(
                          'Professional assignment pending',
